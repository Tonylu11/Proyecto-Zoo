...
/**
 * Ventana para hacer desplazarse a un animal.
 * 
 * @author Antonio Luque Bravo
 *
 */
public class DesplazarAnimal extends JDialog {
	...
	public DesplazarAnimal() {
		...
		JButton button = new JButton("Desplazar");
		button.addActionListener(new ActionListener() {
			/**
			 * actionPerformed que desplaza al animal del zoo disminuyendo su
